...
export function registerResources(server, client) {
    ...
    server.resource("Supported Countries & Regions", "apple-ads://countries", {
        ...
        const resp = await client.get("/countries-or-regions");
    ...
    server.resource("App Preview Device Sizes", "apple-ads://device-sizes", {
    ...
    server.resource("Apple Search Ads Metrics Glossary", "apple-ads://metrics-glossary", {
