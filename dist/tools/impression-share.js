...
export function registerImpressionShareTools(server, client) {
    server.registerTool("create_impression_share_report", {
        ...
        try {
            ...
            const resp = await client.post("/custom-reports", body);
            return {
                content: [
    ...
    server.registerTool("get_impression_share_report_by_id", {
        ...
        try {
            const resp = await client.get(`/custom-reports/${reportId}`);
            return {
                content: [
    ...
    server.registerTool("list_impression_share_reports", {
        ...
        try {
            ...
            const resp = await client.get("/custom-reports", params);
...
//# sourceMappingURL=impression-share.js.map