...
export function registerOrganizationTools(server, client) {
    server.registerTool("list_organizations", {
        ...
        try {
            const resp = await client.get("/acls", undefined, { skipOrgHeader: true });
    ...
    server.registerTool("get_me_details", {
        ...
        try {
            const resp = await client.get("/me", undefined, { skipOrgHeader: true });
            return {
                content: [
    ...
    server.registerTool("switch_organization", {
