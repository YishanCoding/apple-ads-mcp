export function formatMoney(m) {
    if (!m || m.amount == null || m.currency == null)
        return "N/A";
...
export function formatCampaignSummary(c) {
    return [
...
export function formatAdSummary(ad) {
    return [
        `Ad: ${ad.name} (ID: ${ad.id})`,
...
export function formatBudgetOrderSummary(bo) {
    return [
...
export function formatCreativeSummary(c) {
    return [
